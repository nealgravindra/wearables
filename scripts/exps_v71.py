...
if __name__ == '__main__':
    ...
    parser.add_argument('--trial', type=str, default=0, help='Replicate number')
    ...
    parser.add_argument('--criterion', type=str, default='MSEL1', help='specify one of MSE or MSEL1')
    parser.add_argument('--batch_size', type=int, default=32)
    parser.add_argument('--lr', type=float, default=0.01, help='learning rate')
    parser.add_argument('--nb_epochs', type=int, default=10000)
    parser.add_argument('--patience', type=int, default=100, help='if 0, assume there is no patience added')
    parser.add_argument('--min_nb_epochs', type=int, default=200, help='if patience, do not start scheme until after this epoch passed')
    parser.add_argument('--scheduler', type=bool, default=True, help='use learning rate scheduler (if True, lr becomes initial)')
    parser.add_argument('--lambda_l1', type=float, default=1e-6, help='L1 regularization')
    parser.add_argument('--lambda_l2', type=float, default=1e-3, help='weight decay')
    ...
    parser.add_argument('--prop_trainset', type=float, default=1.0, help='what proportion of the train set size to take?')
    parser.add_argument('--model_path', type=str, default='/home/ngrav/scratch/wearables_model_zoo')
    parser.add_argument('--train_out_file', type=str, default='/home/ngrav/project/wearables/results/train_v71.csv')
    parser.add_argument('--eval_out_file', type=str, default='/home/ngrav/project/wearables/results/eval_v71.csv')
    ...
    trainer = weartrain.train(
        ...
        prop_trainset=args.prop_trainset,
