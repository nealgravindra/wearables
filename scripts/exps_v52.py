...
if __name__ == '__main__':
    ...
    parser.add_argument('--nb_layers', type=int, default=6, help='specify the number of layers for InceptionTime. Ignored if other model used')
    ...
    parser.add_argument('--train_out_file', type=str, default='/home/ngrav/project/wearables/results/train_v52.csv')
    parser.add_argument('--eval_out_file', type=str, default='/home/ngrav/project/wearables/results/eval_v52.csv')
